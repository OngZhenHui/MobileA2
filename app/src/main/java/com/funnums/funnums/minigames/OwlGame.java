...
public class OwlGame extends MiniGame {
    ...
    public synchronized void init() {
        ...
        com.funnums.funnums.maingame.GameActivity.gameView.setMenuBackdrop("OwlGame/FlyMenuBoard.png");
    ...
    private void initBackgrounds(){
        ...
        ScrollingBackground bg1 = new ScrollingBackground(
                screenX,
                screenY,
                "OwlGame/MainBackground.png", screenY/8, screenY * 1/2 + overlap, 1f);

        ScrollingBackground bg2 = new ScrollingBackground(
                screenX,
                screenY,
                "OwlGame/LandBackground.png", screenY * 1/2,  (int)(screenY-tileBuffer - exprBuffer/*-overlap/2*/), 2f);
        ...
        ScrollingBackground bg8 = new ScrollingBackground(
                screenX,
                screenY,
                "OwlGame/numContain.png", (int)(screenY-exprBuffer) -waveOffset*2,  (int)(screenY), 2);
        ...
        bg = com.funnums.funnums.maingame.GameView.loadBitmap("OwlGame/SkyBackground.png", false);
